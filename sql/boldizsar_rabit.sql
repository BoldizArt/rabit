...
--
-- Host: localhost    Database: boldizsar_rabit
-- ------------------------------------------------------
...
CREATE TABLE `advertisment` (
  ...
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`),
  CONSTRAINT `advertisment_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
-- Dump completed on 2019-04-30 19:41:54
